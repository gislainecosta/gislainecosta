...
<style xmlns="http://purl.org/net/xbiblio/csl" class="in-text" version="1.0" demote-non-dropping-particle="never" default-locale="pt-BR">
  <info>
    <title>Adaptado de UFRGS - ABNT 6023:2025 e 10520:2023 com DOI</title>
    <title-short>Adaptado UFRGS ABNT 2025 DOI</title-short>
    <id>https://github.com/gislainecosta/abnt-csl-mendeley</id>
    <link href="https://github.com/gislainecosta/abnt-csl-mendeley/blob/main/adaptado-ufrgs-abnt-2025-com-doi-github-v3.csl" rel="self"/>
    ...
    <link href="https://www.ufrgs.br/bibliotecas/ferramentas/campos-basicos-abnt-mendeley" rel="documentation"/>
    <!-- Para alguns itens do Mendeley é necessário incluir novos campos -->
    <link href="https://www.ufrgs.br/bibliotecas/ferramentas/campos-basicos-abnt-zotero" rel="documentation"/>
    ...
    <!-- Adaptação 2025: versão customizada para Mendeley com DOI priorizado e tratamento de ISBN/ISSN por tipo documental, mantendo a base autoral e institucional do estilo UFRGS. -->
    <author>
    ...
    <author>
      <name>Marina Plentz</name>
      <email>marina.plentz@ufrgs.br</email>
    </author>
    <author>
    ...
    <contributor>
      <name>Gislaine Costa Pereira</name>
      <email>devgislainecosta@gmail.com</email>
      <uri>https://github.com/gislainecosta</uri>
    </contributor>
    <category citation-format="author-date"/>
    <category field="generic-base"/>
    <summary>Estilo adaptado do modelo UFRGS-ABNT, com ajustes para ABNT 6023:2025 e ABNT 10520:2023, incluindo priorização de DOI, tratamento de ISBN por tipo documental, retirada de ISSN como fallback para artigos comuns e abreviação de volume/número como v./n.</summary>
  ...
  <locale xml:lang="pt-BR">
    <terms>
      ...
      <!-- Adaptação 2025: força abreviações usuais em referências ABNT para volume e número, evitando saída como "vol." e "no". -->
  ...
  <macro name="access">
    <!-- Adaptação 2025: apresenta URL e data de acesso somente quando houver URL cadastrada; evita referências com "Disponível em:" vazio. -->
    <choose>
      <if variable="URL">
  ...
  <macro name="identifiers">
    <!-- Adaptação 2025: imprime identificadores persistentes conforme o tipo documental, priorizando DOI por identificar o documento específico. -->
    <choose>
      <!-- Artigos: DOI identifica o artigo específico. O ISSN não é impresso como fallback em artigos comuns para evitar poluição da referência, pois identifica o periódico como um todo. -->
      <if type="article-journal article-magazine article-newspaper" match="any">
      <!-- Adaptação: em artigos, o DOI identifica o artigo específico e tem prioridade.
           Quando não houver DOI, o ISSN é usado como fallback para identificar o periódico. -->
      <choose>
        <if variable="DOI">
      ...
      <!-- Livros: DOI, quando houver, é mais específico; na ausência dele, imprime ISBN. -->
      ...
      <!-- Capítulos: prioriza DOI do capítulo; se não houver, usa ISBN do livro quando cadastrado. -->
      ...
      <!-- Trabalhos em evento: DOI primeiro; depois ISBN ou ISSN conforme o tipo de publicação dos anais. -->
      ...
      <!-- Teses, relatórios, documentos, softwares, datasets e páginas: imprime DOI quando o identificador existir. -->
      <else-if type="thesis report document manuscript software dataset webpage post post-weblog" match="any">
        <choose>
          <if variable="DOI">
            <text variable="DOI" prefix=" DOI: " suffix="."/>
          </if>
      ...
      <!-- Fallback geral para tipos não previstos: DOI > ISBN > ISSN. -->
      <else>
        <choose>
          <if variable="DOI">
            <text variable="DOI" prefix=" DOI: " suffix="."/>
      ...
      <choose>
        <if type="article">
          ...
          <group>
            ...
            <text variable="genre" suffix="."/>
            <!-- Adaptação 2025: posiciona DOI/ISBN/ISSN antes das informações de URL e acesso. -->
